...
class CompatibilityTest
{
    ...
    {
        $text = implode("\n", $this->lines);
        echo $this->isCli ? $text : "<html lang=''><body>{$text}</body></html>";
    }
    ...
    public function check($info, $func, $text, $required): void
    {
    ...
    public function addRecommend($info, $func, $text): void
    {
        $this->check($info, $func, $text, false);
    }

    public function addRequire($info, $func, $text): void
    {
        $this->check($info, $func, $text, true);
    }

    public function iniCheck($info, $setting, $expected, $required = true, $help = null): void
    {
    ...
    public function extCheck($ext, $required = true, $help = ''): void
    {
...
// some space at the end
    $c->title('PHP Info');
    $c->write('<strong>---> <a href="info.php">View PHP information</a></strong>');
}
