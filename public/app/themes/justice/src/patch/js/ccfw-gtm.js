   ...
   */
    ...
    patch: {
        popup:{
            button: {
                save:  () => {
                    const button = jQuery(CCFW.jq.button.save_preferences.find('button')).clone(true);
                    ...
                    jQuery(CCFW.jq.toggles).on('click', () => jQuery('#cookie-save-preferences-top').removeAttr('disabled'))
                }
            }
        }
    }
