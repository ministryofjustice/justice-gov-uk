...
```
You should be able to find the required variables for each component in the matching `.twig.html` file in the frontend.
4. Go to `justice.docker` and you should see your component. Any changes made in the frontend will be reflected but you will need to refresh the page.
