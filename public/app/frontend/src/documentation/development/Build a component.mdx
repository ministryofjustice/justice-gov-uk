...
3. Add any JavaScript to `index.js` in a default export. See Setup step 4 above for an example.
...
In Storybook open your component and press `⌥ + A` to open the addons panel. Click on the Accessibility tab to view any violations.
